        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/indieboxproductions/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#EAE9DE] transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/indieboxproductions/about/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#EAE9DE] transition-colors" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
